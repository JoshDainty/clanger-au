            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-border">
                  <div className="flex items-center gap-2">
                    <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs text-text-tertiary hover:text-text-secondary hover:bg-white/5 transition-colors">
          ...
          <div className="bg-bg-card border border-border rounded-2xl overflow-hidden">
            ...
            <div className="divide-y divide-border">
              {trendingTopics.map(topic => (
                <button key={topic.tag} className="w-full flex items-center justify-between px-4 py-3 hover:bg-white/[0.02] transition-colors text-left">
                  <div>
                    <div className="text-sm font-semibold text-text-primary">#{topic.tag}</div>
